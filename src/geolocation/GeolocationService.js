...
export class GeolocationService {
    ...
    async getCurrentCoordinates(
        ...
        if (
            ...
            throw new Error(
                "Geolocation is not supported by your current web browser.",
            );
        }
            ...
            navigator.geolocation.getCurrentPosition(
                (position) => {
                    if (
                        ...
                        reject(
                            new Error(
                                "Invalid geolocation position data received from device.",
                            ),
                        );
                    }
                },
                (geolocationError) => {
                    ...
                    if (
                        ...
                        errorMessage =
                            "Your current location is currently unavailable. Please check your connection or GPS.";
                    } else if (
